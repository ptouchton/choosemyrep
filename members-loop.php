			...
			<div class="item-container">
				<div class="item-content clearfix">
					...
					<header class="item-header">
						...
						<div style="padding: 4px;  height:95px">
						  <div>
                            <?php echo bp_member_profile_data('field=Occupation'); ?>
						  </div>
                          <div style="margin-top: 15px;">						  
                            <?php echo bp_member_profile_data('field=Phone Number'); ?>
						  </div>
                          <div style="margin-top: 5px;">						  
						     <a href="mailto:<?php echo bp_member_profile_data('field=Contact Email'); ?>">
						        <?php echo bp_member_profile_data('field=Contact Email'); ?>
						     </a>	
						  </div>	 
						</div>  
					...
					<?php
					  ...
					  *
					  * bp_member_profile_data( 'field=Contact email' );
					  */
					?>
